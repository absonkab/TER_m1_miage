		...
		<div class="login-box">
			<div class="login-box-body">
				<h3 class="login-box-msg">Inscription</h3>
					...
					<form class="success" id="form" method="POST" action="{{ route('register') }}">
						@csrf
						...
						<div class="col-xs-4 m-t-1">
							<button id="submit" type="submit" class="btn btn-primary btn-block btn-flat" disabled> {{ __("S'inscrire") }}</button>
						</div>
						<!-- /.col --> 
